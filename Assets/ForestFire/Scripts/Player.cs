...
//    public Rigidbody playerBody;                                //declaring rigidbody for player

//    public BoxCollider FireArea;

//    //public ForestFireCell fireCell;

//    public int maxHealth = 100;                                 //sets player max health
//    public int currentHealth;                                   //creates a value for current player health
//    private float playerX, playerY, playerZ;                     //creates values for player positions on x, y, z axis
//    public int playerXint, playerYint, playerZint;              //creates values for player positions on x, y, z axis as whole numers
//    private float fireX, fireY, fireZ;                           //creates values for fire positions on x, y, z axis
...
//        FireArea = GetComponent<BoxCollider>();
//    }
...
//    //public void OnTriggerEnter(Rigidbody playerBody)
//    //{
//    //    TakeDamage(10);
//    //}
